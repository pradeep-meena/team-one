...
<div className="container">
 <div className="row text-center">
   <div className="col-lg-8 offset-lg-2">
     ...
     Your business finance, Analysed, Sorted and housed under one roof, Quoting, invoicing, payments
 ...
 <div className="row feature-cards">
   <div className="col-md-4 col-lg-4 mb-4">
     <div className="feature-card p-4 d-flex flex-column">
       ...
       <p style={{ fontSize: 18 }}>
       All the tools you need to pay, and get
       paid.Take full control of your business finances with an all-in-one solution designed to streamline your cash flow.<br/> From quoting and invoicing to payments and expense tracking, we provide all the tools you need to pay and get paid—quickly, securely, and effortlessly.
