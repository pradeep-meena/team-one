      ...
      <div className="row">
        <div className="col-md-6 d-flex align-items-center">
          <div className="text">
            ...
            <p className="fs-5">
              Manage stock levels with ease. Inventory management and equipment
              hire software to keep your warehouse on track, and give your staff
              the overview they need over your goods in/out process.
            </p>
          </div>
        </div>
