...
<>
  ...
  <div className="container text-center mt-5">
    <div className="row">
      <div className="col">
        <h1 style={{ fontWeight: "bold", color: "black", fontSize: 100 }}>
          An easy new way to
        </h1>
        <h1 style={{ fontWeight: "bold", color: "black", fontSize: 100 }}>
          manage
  ...
  <div className="container text-center mt-5">
    ...
    <div className="row justify-content-center">
      <div className="col-md-10">
        <img
          src="https://halopsa.wpenginepowered.com/wp-content/uploads/2020/11/HaloPSA-Triple-Shot-V6-1536x550.png"
          alt="HaloPSA Dashboard"
